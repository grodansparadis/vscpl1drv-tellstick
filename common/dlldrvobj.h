...
#define CANAL_TELLSTICK_DRIVER_MAX_OPEN	256
...
public:
	...
	*/
	long addDriverObject( CTellstickObj *pObj );
	...
	/*!
		...
		@return pointer to object or NULL if invalid
				handle.
	*/
	CTellstickObj *getDriverObject( long h );
	...
	*/
	CTellstickObj *m_drvObjArray[ CANAL_TELLSTICK_DRIVER_MAX_OPEN ];
